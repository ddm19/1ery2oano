...
{
    return a_dia==d.a_dia and a_mes==d.a_mes and a_any==d.a_any;
}
...
// Pre: cert; // Post: cert si dia/mes/any seria una data vàlida en el calendari gregorià (entre l’any 1600 i 4000), fals altrament
    bool correcte = true;
